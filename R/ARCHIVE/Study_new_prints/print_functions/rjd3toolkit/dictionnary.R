dictionnary <- data.frame(
    ...
    definition = c(
        ...
        "Leap year effect",
        "Trading Day effect (1 or 6 variables)",
        "The Easter effect",
        "Total Outlier Effect",
        "Additive outlier effect",
        "Level shift effect",
        "Transitory effect",
        ...
        "Unmodified Seasonal - Irregular Component",
        "Replacement Values for Extreme SI Values",
        "Seasonal Component",
        "Seasonally Adjusted Series",
        "Irregular Component",
        "Preliminary Weights for the Irregular",
        "Adjustment Values for Extreme Irregulars",
        "Modified Raw Series",
        ...
        "Forecast of Final Seasonal Factors",
        "Final Seasonally Adjusted Series",
        "Forecast of Final Seasonally Adjusted Series",
        "Final Trend (estimation using Henderson movingaverage)",
        "Forecast of Final Trend Component",
        "Final Irregular Component",
        "Seasonal and Calendar Effects",
        "Forecast of Seasonal and Calendar Component",
        "Combined Calendar Effects Factors",
