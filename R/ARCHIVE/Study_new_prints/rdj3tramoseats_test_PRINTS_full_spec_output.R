...
#####  set arima
spec_ts_d <- set_automodel(spec_ts_d, enabled = FALSE)
spec_ts_d <- set_arima(
    spec_ts_d,
    mean = 0.2,
    mean.type = "Fixed",
...
### add ramp
# ramp on year 2021
spec_ts_d <- rjd3toolkit::add_ramp(
    spec_ts_d,
    start = "2021-01-01",
    end = "2021-12-01"
)
