...
# remotes::install_local("HF_simulations/tssim_0.2.15.tar.gz")
...
source("HF_simulations/UC_on_Sim_data_additive_det_S2.R")
gamma_2 <- gamma

source("HF_simulations/UC_on_Sim_data_additive_det_S3.R")
gamma_3 <- gamma

source("HF_simulations/UC_on_Sim_data_additive_det_S4.R")
gamma_4 <- gamma
sigma_4 <- sigma2

source("HF_simulations/UC_on_Sim_data_additive_det_S5.R")
gamma_5 <- gamma
sigma_5 <- sigma2

source("HF_simulations/UC_on_Sim_data_additive_det_S6.R")
gamma_6 <- gamma
sigma_6 <- sigma2
toc()
