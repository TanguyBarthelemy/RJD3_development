...
Il n'est pas possible de créer des variables dynamique (avec des ts metadata). On ne peut créer que des objets statiques.
...
#### Quelle plu-value à `add_variables()`{.r} ?
