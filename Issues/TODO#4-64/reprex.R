...
JDCruncheR::export_xlsx(x = QR_auto_score, file_name = "./Issues/TODO#4-64/export_all.xlsx", layout = "all")
JDCruncheR::export_xlsx(x = QR_auto_score, file_name = "./Issues/TODO#4-64/export_modalities.xlsx", layout = "modalities")
JDCruncheR::export_xlsx(x = QR_auto_score, file_name = "./Issues/TODO#4-64/export_values.xlsx", layout = "values")
JDCruncheR::export_xlsx(x = QR_auto_score, file_name = "./Issues/TODO#4-64/export_combined.xlsx", layout = "combined")
