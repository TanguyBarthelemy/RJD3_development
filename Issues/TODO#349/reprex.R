...
mod_v2 <- RJDemetra::x13(x, spec = spec_v2,
                         userdefined = var_v2)
mod_v2 <- RJDemetra::x13(x, spec = "RSA3",
                         userdefined = all_input_v2)

### V3 -------------------------------------------------------------------------

spec_v3 <- rjd3x13::x13_spec("rsa3") |>
    rjd3toolkit::set_outlier(span.type = "From",
                             d0 = "1952-01-01",
                             outliers.type = c("LS", "AO"),
                             critical.value = 5.34,
                             tc.rate = 0.85,
                             method = "AddOne") |>
    rjd3toolkit::add_outlier(type = c("LS", "AO"),
                             date = c("1954-10-01", "1955-01-01"),
                             coef = c(36.9, 14.1)) |>
    rjd3toolkit::set_transform(fun = "Log",
                               adjust = "LeapYear",
                               outliers = TRUE,
                               aicdiff = -5.21,
                               fct = -0.45) |>
    rjd3toolkit::set_basic(type = "Between",
                           d0 = "1949-01-01",
                           d1 = "1960-12-01",
                           preliminary.check = TRUE,
                           preprocessing = TRUE) |>
    rjd3toolkit::set_estimate(type = "Between",
                              d0 = "1951-06-01",
                              d1 = "1957-06-01",
                              tol = 0.45) |>
    rjd3toolkit::set_automodel(enabled = TRUE,
                               ub1 = 1.0212,
                               ub2 = 1.2101,
                               ubfinal = 1.042,
                               mixed = FALSE,
    ...
    rjd3x13::set_x11(mode = "Multiplicative",
                     lsigma = 1.6,
                     usigma = 2.4,
                     fcasts = 17,
                     bcasts = 15,
...
mod_v3 <- rjd3x13::x13(x, spec = spec_v3,
                       userdefined = var_v3)
mod_v3 <- rjd3x13::x13(x, spec = "RSA3",
                       userdefined = var_v3)
mod_v3 <- rjd3x13::x13(x, spec = spec_v3,
