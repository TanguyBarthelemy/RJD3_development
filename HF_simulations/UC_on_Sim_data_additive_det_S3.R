...
# stockage scenario _s3
s7_s3<-c(avg_x11_s7,avg_stl_s7,avg_amb_s7, avg_Mamb_s7,avg_Tbats_s7,avg_Prophet_s7,avg_MSTL_s7)
s7_s3

s365_s3<-c(avg_x11_s365,avg_stl_s365,avg_amb_s365, avg_Mamb_s365,avg_Tbats_s365,avg_Prophet_s365,avg_MSTL_s365)
s365_s3

t_s3<-c(avg_x11_t,avg_stl_t,avg_amb_t, avg_Mamb_t,avg_Tbats_t,avg_Prophet_t,avg_MSTL_t)
t_s3

i_s3<-c(avg_x11_i,avg_stl_i,avg_amb_i, avg_Mamb_i,avg_Tbats_i,avg_Prophet_i,avg_MSTL_i)
i_s3

sa_s3<-c(avg_x11_sa,avg_stl_sa,avg_amb_sa, avg_Mamb_sa,avg_Tbats_sa,avg_Prophet_sa,avg_MSTL_sa)
sa_s3

time_s3<-c(avg_x11_time,avg_stl_time,avg_amb_time, avg_Mamb_time,avg_Tbats_time,avg_Prophet_time,avg_MSTL_time)
time_s3
