...
spec_x13_d <- set_basic(spec_x13_d,
    type = "First", n0 = 60,
...
new_spec <- set_estimate(init_spec,
...
init_spec <- rjd3tramoseats::spec_tramoseats("rsafull")
new_spec <- set_outlier(init_spec,
...
set_tradingdays(
    x,
    option = c(
        NA, "TradingDays", "WorkingDays", "TD3", "TD3c", "TD4", "None",
        "UserDefined"
    ),
    uservariable = NA,
    stocktd = NA,
