...
BQ_auto <- extract_QR("workspace_de_travail/industrie/output/industrie/demetra_m.csv")
...
write.xlsx(fichier_decisions, "Bilans qualite/Decisions_2024_2012.xlsx", showNA = FALSE)
